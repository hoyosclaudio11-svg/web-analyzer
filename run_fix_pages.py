...
with open("E:/DelMonte/web-analyzer/fix_latest_posts.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR fix_latest_posts.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/fix_latest_posts.php", timeout=120)
print(r.text)
...
ftp2.delete("fix_latest_posts.php")
ftp2.quit()
print("Done")
