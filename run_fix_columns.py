...
with open("E:/DelMonte/web-analyzer/fix_columns.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR fix_columns.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/fix_columns.php", timeout=120)
print(r.text)
