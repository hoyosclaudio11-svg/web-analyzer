...
with open("E:/DelMonte/web-analyzer/complete_site.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR complete_site.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/complete_site.php", timeout=180)
with open("E:/DelMonte/web-analyzer/complete_output.txt", "w", encoding="utf-8") as f:
    f.write(r.text)
