...
with open("E:/DelMonte/web-analyzer/fix_inicio.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR fix_inicio.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/fix_inicio.php", timeout=120)
print(r.text)
