...
with open("E:/DelMonte/web-analyzer/fix_inicio_db.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR fix_inicio_db.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/fix_inicio_db.php", timeout=120)
print(r.text)
