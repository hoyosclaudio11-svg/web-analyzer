...
with open("E:/DelMonte/web-analyzer/river_create_events.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR river_create_events.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/river_create_events.php", timeout=60)
print(r.text)
...
ftp2.delete("river_create_events.php")
ftp2.quit()
