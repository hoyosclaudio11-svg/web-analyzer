...
with open("E:/DelMonte/web-analyzer/fix_noticias.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR fix_noticias.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/fix_noticias.php", timeout=120)
print(r.text)
