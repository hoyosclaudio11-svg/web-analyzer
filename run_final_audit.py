...
with open("E:/DelMonte/web-analyzer/final_audit.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR final_audit.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/final_audit.php", timeout=60)
print(r.text)
