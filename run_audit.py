...
with open("E:/DelMonte/web-analyzer/audit_river.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR audit_river.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/audit_river.php", timeout=60)
print(r.text)
