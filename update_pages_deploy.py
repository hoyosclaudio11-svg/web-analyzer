...
with open("E:/DelMonte/web-analyzer/river_update_pages.php", "rb") as f:
    data = f.read()
ftp.cwd("/public_html")
ftp.storbinary("STOR river_update_pages.php", io.BytesIO(data))
ftp.quit()

r = requests.get("https://riverplate-info.com.ar/river_update_pages.php", timeout=60)
print(r.text)
...
ftp2.delete("river_update_pages.php")
ftp2.quit()
print("Done")
